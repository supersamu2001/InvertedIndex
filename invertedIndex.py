...
if __name__ == "__main__":
    ...
    try:
        ...
        # partition di 250 files --> 37 s (stage 0) 9 s (stage 1) --> 47 s [300060_0055] (6 task)

        # DATASET 246KB
        # due partition da 3 files --> 6 s (stage 0) 1 s (stage 1) --> 7 s  [300060_0056] (2 task)
        rdd = sc.wholeTextFiles(input_dir, minPartitions=(max(2, int(n_files / 1000))))
